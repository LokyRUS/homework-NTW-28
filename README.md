...
- Какой маршрутной информацией будет обладать маршрутизатор D о доступности сети 172.17.1.0? ((40:28))
- Как будут выглядеть атрибуты AS-path? (43:55)
...
# Ответ
1. 172.17.1.0 via 172.20.1.1
2. AS-path [60000, 40000]
3. Выбирается более короткий маршрут. Трафик пройдет через роутер Router E,Router D,E и до Router A 
### Задание 2
