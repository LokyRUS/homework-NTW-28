...
|VLAN|Пользователи|сеть/ip address|
|---|---|---|
|VLAN10|IT(IT-отдел) |192.168.10.0/24|
|VLAN20|manager (менеджеры по продажам)|192.168.20.0/24|
|VLAN30|topmanager (ТОП-менеджеры)|192.168.30.0/24|
|VLAN40|security (служба безопасности)|192.168.40.0/24|
|VLAN50|Buh (бухгалтерия)|192.168.50.0/24|
|---|WLC|192.168.10.50/24|
# `Сегиентирование беспроводной сети`
|VLAN|Пользователи|
|---|---|
|VLAN20|AP1|
|VLAN30|AP2|
# Планирование Производственный цех
|Пользователи|сеть/ip address|
|---|---|
|Работкники|172.16.1.0/24|
# Планирование Склад 
|Пользователи|сеть/ip address|
|---|---|
|Работкники|172.20.1.0/24|
# Планирование Маркет
|Пользователи|сеть/ip address|
|---|---|
|Работкники|172.30.1.0/24|

|Цели|
|---|
|### Для связки с офисами используются VPN-Тоннели|
|### Динамическая маршрутизация|

### Wi-FI точки для Менеджеров и отдельно для TOP-Менеджеров 
### Vlan10 - IT-Отдела имеет доступ ко всем сегментам сити, для администрирования. 
### WI-FI Управляется через WLC
### Камеры подведомственны Vlan Охраны. 
