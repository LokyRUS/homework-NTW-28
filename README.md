...
~~ 4)После изменения, OSPF предложить установить, в таблицу маршрутизации, межзонный маршрут  R1-R3-R4, как самый дешовый и оптимальный.
...
4) После изменения, OSPF предложить установить внутренниq маршрут зоны, в таблицу маршрутизации, межзонный маршрут R4-R5, не учитывая стоимость маршрута.
