...
`vPC` - Основное преимущество, это независимостью коммутаторов, это соответствует существующему подходу к дизайну SAN
...
`StackWise` - думаю это позволит, путем объединения, организовать отказоустойчивость, при этом позволиет упростить расширение и имеется единое управлением. 
