...
------
# Ответ
Можно воспользоваться шлюзом VOip FXS шлюзом. Это устройство, которое соединяет аналоговую сеть, с сетью VoIP. Шлюз преобразует аналоговые сигналы от устройства, в цифровые сигналы.
...
------
# Ответ
Могу предположить, что правельным решением в данном случае будет оргнанизовать IP-АТС, по принципу "Объединение офисов с помощью IP-АТС". в первом офисе, следует организовать,шлюз для подключения аналоговой линии. Мини офис уже имеет свою мини-АТС Подключаем во внешнюю IP-сеть удалённые офисы. Всё это подключается и объединяется в одну IP-АТС.
